...
const UI_LABELS = {
  English: {
    ...
    mandiCrops: {
      ...
      amaranthLeaves: "Amaranth leaves",
      artichoke: "Artichoke",
      arugula: "Arugula",
      asparagus: "Asparagus",
      ...
      edamame: "Edamame",
      endive: "Endive",
      favaBeans: "Fava beans (Broad beans)",
      fennel: "Fennel",
      fenugreekLeaves: "Fenugreek leaves",
      ...
      malabarSpinach: "Malabar spinach",
      mint: "Mint",
      mushroom: "Mushroom",
      ...
      pointedGourd: "Pointed gourd",
      pumpkin: "Pumpkin",
      redCabbage: "Red cabbage",
      ridgeGourd: "Ridge gourd",
      rocketLeaves: "Rocket leaves",
      shallot: "Shallot",
  ...
  Hindi: {
    ...
    mandiCrops: {
      ...
      bitterGourd: "करेला",
      bottleGourd: "लौकी",
      amaranthLeaves: "चौलाई के पत्ते",
      artichoke: "हाथीचक",
      arugula: "अरुगुला",
      asparagus: "शतावरी",
      aubergine: "बैंगन",
      bambooShoots: "बांस के अंकुर",
      bananaFlower: "केले का फूल",
      beetGreens: "चुकंदर के पत्ते",
      beetroot: "चुकंदर",
      bellPepper: "शिमला मिर्च",
      bokChoy: "बोक चॉय",
      broccoli: "ब्रोकली",
      brusselsSprouts: "ब्रसेल्स स्प्राउट्स",
      calabash: "लौकी",
      ...
      chiliPepper: "मिर्च",
      chives: "चाइव्स",
      clusterBeans: "ग्वार फली",
      collardGreens: "कोलार्ड ग्रीन्स",
      corn: "मक्का",
      courgette: "तोरई (ज़ुचिनी)",
      cucumber: "खीरा",
      curryLeaves: "कड़ी पत्ता",
      daikon: "सफेद मूली",
      drumstick: "सहजन",
      edamame: "एडामामे",
      endive: "कासनी",
      favaBeans: "बाकला",
      fennel: "सौंफ",
      fenugreekLeaves: "मेथी",
      greenBeans: "हरी फलियाँ",
      greenPeas: "हरी मटर",
      ivyGourd: "कुंदरू",
      jalapeno: "जलपेनो",
      kale: "केल",
      ...
      leek: "लीक",
      lettuce: "सलाद पत्ता",
      limaBeans: "लीमा बीन्स",
      lotusRoot: "कमल ककड़ी",
      malabarSpinach: "पोई साग",
      mint: "पुदीना",
      mushroom: "मशरूम",
      mustardGreens: "सरसों का साग",
      olive: "जैतून",
      parsley: "पार्सले",
      parsnip: "पार्सनिप",
      peas: "मटर",
      ...
      pointedGourd: "परवल",
      pumpkin: "कद्दू",
      redCabbage: "लाल पत्ता गोभी",
      ridgeGourd: "तोरई",
      rocketLeaves: "रॉकेट लीव्स",
      shallot: "छोटा प्याज",
      snakeGourd: "चिचिंडा",
      snowPeas: "स्नो पीज़",
      sorrel: "सोरेल",
      springOnion: "हरा प्याज",
      squash: "स्क्वैश",
      sweetPotato: "शकरकंद",
      taro: "अरबी",
      thyme: "थाइम",
  ...
  Marathi: {
    ...
    mandiCrops: {
      ...
      asparagus: "शतावरी",
      aubergine: "वांगी",
      bambooShoots: "बांबूचे कोंब",
      bananaFlower: "केळफूल",
      beetGreens: "बीटची पाने",
      beetroot: "बीट",
      bellPepper: "ढोबळी मिरची",
      bokChoy: "बोक चॉय",
      broccoli: "ब्रोकोली",
      brusselsSprouts: "ब्रसेल्स स्प्राउट्स",
      calabash: "दुधी भोपळा",
      ...
      fennel: "बडीशेप",
      fenugreekLeaves: "मेथी",
      greenBeans: "श्रावण घेवडा",
      greenPeas: "हिरवा मटार",
      ivyGourd: "तोंडली",
      jalapeno: "जलपेनो",
      kale: "केल",
      kohlrabi: "नवलकोल",
      ...
      lettuce: "सॅलडची पाने",
      limaBeans: "लीमा बीन्स",
      lotusRoot: "कमळाचे देठ",
      malabarSpinach: "मायाळू",
      mint: "पुदीना",
      mushroom: "अळंबी",
      mustardGreens: "मोहरीची पाने",
      olive: "ऑलिव्ह",
      parsley: "पार्सले",
      parsnip: "पार्सनिप",
      peas: "मटार",
      ...
      turnip: "शलजम",
      turmeric: "हळद",
      waterChestnut: "शिंगाडा",
      waterSpinach: "नाळची भाजी",
      yam: "सुरण",
      zucchini: "झुकिनी",
      apple: "सफरचंद",
      banana: "केळी",
            ...
            >
              ...
              <div className="space-y-3 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                {[
                  ...
                  { key: 'amaranthLeaves', basePrice: 15, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'artichoke', basePrice: 180, unit: labels.pricePerKg, trend: '+5%', cat: 'vegetables' },
                  { key: 'arugula', basePrice: 120, unit: labels.pricePerKg, trend: '+3%', cat: 'vegetables' },
                  { key: 'asparagus', basePrice: 250, unit: labels.pricePerKg, trend: '+8%', cat: 'vegetables' },
                  { key: 'aubergine', basePrice: 25, unit: labels.pricePerKg, trend: '-2%', cat: 'vegetables' },
                  { key: 'bambooShoots', basePrice: 80, unit: labels.pricePerKg, trend: '+4%', cat: 'vegetables' },
                  { key: 'bananaFlower', basePrice: 30, unit: labels.pricePerKg, trend: '+1%', cat: 'vegetables' },
                  { key: 'beetGreens', basePrice: 20, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'beetroot', basePrice: 35, unit: labels.pricePerKg, trend: '+3%', cat: 'vegetables' },
                  { key: 'bellPepper', basePrice: 60, unit: labels.pricePerKg, trend: '-5%', cat: 'vegetables' },
                  { key: 'bokChoy', basePrice: 90, unit: labels.pricePerKg, trend: '+6%', cat: 'vegetables' },
                  { key: 'broccoli', basePrice: 100, unit: labels.pricePerKg, trend: '+10%', cat: 'vegetables' },
                  { key: 'brusselsSprouts', basePrice: 150, unit: labels.pricePerKg, trend: '+12%', cat: 'vegetables' },
                  { key: 'calabash', basePrice: 20, unit: labels.pricePerKg, trend: '-2%', cat: 'vegetables' },
                  { key: 'capsicum', basePrice: 55, unit: labels.pricePerKg, trend: '-4%', cat: 'vegetables' },
                  { key: 'cassava', basePrice: 40, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'celery', basePrice: 70, unit: labels.pricePerKg, trend: '+5%', cat: 'vegetables' },
                  { key: 'chard', basePrice: 85, unit: labels.pricePerKg, trend: '+3%', cat: 'vegetables' },
                  { key: 'chiliPepper', basePrice: 50, unit: labels.pricePerKg, trend: '-3%', cat: 'vegetables' },
                  { key: 'chives', basePrice: 110, unit: labels.pricePerKg, trend: '+4%', cat: 'vegetables' },
                  { key: 'clusterBeans', basePrice: 45, unit: labels.pricePerKg, trend: '+6%', cat: 'vegetables' },
                  { key: 'collardGreens', basePrice: 65, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'corn', basePrice: 30, unit: labels.pricePerKg, trend: '+10%', cat: 'vegetables' },
                  { key: 'courgette', basePrice: 75, unit: labels.pricePerKg, trend: '+5%', cat: 'vegetables' },
                  { key: 'cucumber', basePrice: 25, unit: labels.pricePerKg, trend: '-2%', cat: 'vegetables' },
                  { key: 'curryLeaves', basePrice: 100, unit: labels.pricePerKg, trend: '+15%', cat: 'vegetables' },
                  { key: 'daikon', basePrice: 20, unit: labels.pricePerKg, trend: '-1%', cat: 'vegetables' },
                  { key: 'drumstick', basePrice: 60, unit: labels.pricePerKg, trend: '+20%', cat: 'vegetables' },
                  { key: 'edamame', basePrice: 200, unit: labels.pricePerKg, trend: '+5%', cat: 'vegetables' },
                  { key: 'endive', basePrice: 140, unit: labels.pricePerKg, trend: '+3%', cat: 'vegetables' },
                  { key: 'favaBeans', basePrice: 90, unit: labels.pricePerKg, trend: '+4%', cat: 'vegetables' },
                  { key: 'fennel', basePrice: 50, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'fenugreekLeaves', basePrice: 15, unit: labels.pricePerKg, trend: '+5%', cat: 'vegetables' },
                  { key: 'greenBeans', basePrice: 55, unit: labels.pricePerKg, trend: '+6%', cat: 'vegetables' },
                  { key: 'greenPeas', basePrice: 80, unit: labels.pricePerKg, trend: '-10%', cat: 'vegetables' },
                  { key: 'ivyGourd', basePrice: 40, unit: labels.pricePerKg, trend: '+3%', cat: 'vegetables' },
                  { key: 'jalapeno', basePrice: 150, unit: labels.pricePerKg, trend: '+8%', cat: 'vegetables' },
                  { key: 'kale', basePrice: 120, unit: labels.pricePerKg, trend: '+10%', cat: 'vegetables' },
                  { key: 'kohlrabi', basePrice: 45, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'leek', basePrice: 95, unit: labels.pricePerKg, trend: '+4%', cat: 'vegetables' },
                  { key: 'lettuce', basePrice: 60, unit: labels.pricePerKg, trend: '+5%', cat: 'vegetables' },
                  { key: 'limaBeans', basePrice: 110, unit: labels.pricePerKg, trend: '+3%', cat: 'vegetables' },
                  { key: 'lotusRoot', basePrice: 130, unit: labels.pricePerKg, trend: '+7%', cat: 'vegetables' },
                  { key: 'malabarSpinach', basePrice: 20, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'mint', basePrice: 80, unit: labels.pricePerKg, trend: '+12%', cat: 'vegetables' },
                  { key: 'mushroom', basePrice: 250, unit: labels.pricePerKg, trend: '+5%', cat: 'vegetables' },
                  { key: 'mustardGreens', basePrice: 25, unit: labels.pricePerKg, trend: '+4%', cat: 'vegetables' },
                  { key: 'olive', basePrice: 400, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'parsley', basePrice: 150, unit: labels.pricePerKg, trend: '+6%', cat: 'vegetables' },
                  { key: 'parsnip', basePrice: 120, unit: labels.pricePerKg, trend: '+3%', cat: 'vegetables' },
                  { key: 'peas', basePrice: 75, unit: labels.pricePerKg, trend: '-5%', cat: 'vegetables' },
                  { key: 'plantain', basePrice: 35, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'pointedGourd', basePrice: 50, unit: labels.pricePerKg, trend: '+4%', cat: 'vegetables' },
                  { key: 'pumpkin', basePrice: 20, unit: labels.pricePerKg, trend: '+1%', cat: 'vegetables' },
                  { key: 'redCabbage', basePrice: 55, unit: labels.pricePerKg, trend: '+3%', cat: 'vegetables' },
                  { key: 'ridgeGourd', basePrice: 40, unit: labels.pricePerKg, trend: '+5%', cat: 'vegetables' },
                  { key: 'rocketLeaves', basePrice: 160, unit: labels.pricePerKg, trend: '+8%', cat: 'vegetables' },
                  { key: 'shallot', basePrice: 90, unit: labels.pricePerKg, trend: '+10%', cat: 'vegetables' },
                  { key: 'snakeGourd', basePrice: 35, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'snowPeas', basePrice: 220, unit: labels.pricePerKg, trend: '+6%', cat: 'vegetables' },
                  { key: 'sorrel', basePrice: 30, unit: labels.pricePerKg, trend: '+4%', cat: 'vegetables' },
                  { key: 'springOnion', basePrice: 40, unit: labels.pricePerKg, trend: '+5%', cat: 'vegetables' },
                  { key: 'squash', basePrice: 50, unit: labels.pricePerKg, trend: '+3%', cat: 'vegetables' },
                  { key: 'sweetPotato', basePrice: 45, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'taro', basePrice: 55, unit: labels.pricePerKg, trend: '+4%', cat: 'vegetables' },
                  { key: 'thyme', basePrice: 300, unit: labels.pricePerKg, trend: '+10%', cat: 'vegetables' },
                  { key: 'turnip', basePrice: 30, unit: labels.pricePerKg, trend: '+2%', cat: 'vegetables' },
                  { key: 'turmeric', basePrice: 120, unit: labels.pricePerKg, trend: '+15%', cat: 'vegetables' },
                  { key: 'waterChestnut', basePrice: 70, unit: labels.pricePerKg, trend: '+8%', cat: 'vegetables' },
                  { key: 'waterSpinach', basePrice: 25, unit: labels.pricePerKg, trend: '+4%', cat: 'vegetables' },
                  { key: 'yam', basePrice: 60, unit: labels.pricePerKg, trend: '+5%', cat: 'vegetables' },
                  { key: 'zucchini', basePrice: 80, unit: labels.pricePerKg, trend: '+6%', cat: 'vegetables' },
                  // Fruits
